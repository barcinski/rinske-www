...
class MultiTouchDragControls extends EventDispatcher {
	...
	constructor( _objects, _camera, _domElement ) {
		...
		function onPointerMove( event ) {
            ...
            if ( pointers.length == 1)scope.mode = "translate"
            else if ( pointers.length > 1) scope.mode = "rotate";
